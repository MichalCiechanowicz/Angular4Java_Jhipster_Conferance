...
/**
 * REST controller for managing {@link com.poweremabox.domain.Session}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Session> result = sessionRepository
            ...
            .map(
                existingSession -> {
                    ...
                    if (session.getDescriptionContentType() != null) {
                        existingSession.setDescriptionContentType(session.getDescriptionContentType());
                    }
