...
import static com.poweremabox.web.rest.TestUtil.sameInstant;
...
import com.poweremabox.repository.SessionRepository;
...
class SessionResourceIT {
    ...
    void putNewSession() throws Exception {
        ...
        updatedSession.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).startTime(UPDATED_START_TIME).endTime(UPDATED_END_TIME);
    ...
    void fullUpdateSessionWithPatch() throws Exception {
        ...
        partialUpdatedSession.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).startTime(UPDATED_START_TIME).endTime(UPDATED_END_TIME);
