package com.poweremabox.repository.rowmapper;

import com.poweremabox.domain.Speaker;
import com.poweremabox.service.ColumnConverter;
...
public class SpeakerRowMapper implements BiFunction<Row, String, Speaker> {
    ...
    public Speaker apply(Row row, String prefix) {
        ...
        entity.setSureName(converter.fromRow(row, prefix + "_sure_name", String.class));
